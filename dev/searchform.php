...
</form> --><!--original search-->

<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/busqueda' ) ); ?>">
	<input type="text" placeholder="Busque un evento" class="menu-search" id="menu-search" name="search" value="<?php echo esc_attr( get_search_query() ); ?>" />
	<button class="searchsubmit" type="submit" id="searchsubmit"><span class="dashicons dashicons-search" id="iconsearch-header"></span></button>
</form><!--custom search-->
</div>
